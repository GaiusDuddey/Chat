    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-dark-950 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-dark-500 mt-1">Sign in to continue to RealChat</p>
        </div>
        ...
        <div className="glass-panel p-6">
          ...
          {/* Demo credentials */}
          <div className="mt-4 p-3 bg-dark-800/30 rounded-xl border border-dark-700/20">
            <p className="text-xs text-dark-500 text-center">
              Demo: <span className="text-dark-400">alice@example.com</span> / <span className="text-dark-400">password123</span>
            </p>
          </div>
        </div>
      </div>
